...
public class DbUtilities {
    ...
    public static final String ROW_IMAGE = "PRODUCT_IMAGE";
    ...
    public static final String CREATE_TABLE_PRODUCTS = "CREATE TABLE " + TABLE_PRODUCTS_NAME +
            " ( " + ROW_ID + " TEXT PRIMARY KEY, " + ROW_NAME + " TEXT NOT NULL, " + ROW_PRICE +
            " INTEGER NOT NULL, " + ROW_IMAGE + " TEXT NOT NULL)";
    ...
    public static final String INSERT_PRODUCTS = "INSERT INTO " + TABLE_PRODUCTS_NAME + " ( " + ROW_ID + ", " +
            ROW_NAME + ", " + ROW_PRICE + ", " + ROW_IMAGE + ") "+
